...
EPOCHS_PHASE1 = 5
EPOCHS_PHASE2 = 20
RESULTS_DIR = "results_resnet50_ft"
DATA_DIR = "data-ar"
N_SPLITS = 10
SEED = 42
...
def load_filepaths_and_labels(data_dir):
    ...
    if not filepaths:
        raise RuntimeError(f"No found pictures in {data_dir}/<class>/*.(jpg|png)")
...
with open(os.path.join(RESULTS_DIR, "README_results.txt"), "w") as f:
    f.write(
        "Results of ResNet50 (ImageNet fine-tune) 10-fold CV on the data-ar dataset (arabica vs robusta)\n"
